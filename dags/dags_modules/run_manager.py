...
class T24:
    ...
    async def load_daily_matches(self):
        ...
        new_players = await self.T24Players.get_all_new_players_from_matches(matches)
        ...
        print('Загружаем матчи в базу')
        await self.DBO.insert_or_update_many(self.__pool, 'public', 't24_matches', matches, ['t24_match_id'])
